...
cylinder= pygame.image.load("cylinder.png")
...
def drawallcovers():
    ...
    for i in range(5,9):  # Creating 2nd row of tiles
        ...
        tX+=200
    for i in range(10,14): # Creating 3rd row of tiles
        i += 1
...
'''def drawallpairs():
    ...
    for i in range(0,3): # Creating 1st row of images
        SCREEN.blit(imagelist[k], (iX,iY))
        k+=1
        iX+=200
    for i in range(4,7):  # Creating 2nd row of images
        SCREEN.blit(imagelist[k], (iX-800,iY+200))
        k+=1
        iX+=200
    for i in range(8,11): # Creating 3rd row of images
